      ...
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <h2 className="about__heading">
            Bay Area Plumbers You Can Actually Count On
          </h2>
          <p className="about__text">
            Bluey Plumbing &amp; Rooter is a licensed, insured plumbing company based in
            Menlo Park serving homeowners and businesses across the Peninsula. We handle
            drain services, gas lines, water heaters, and fixture work — residential and commercial.
          </p>
          <p className="about__text">
            We show up on time, respect your home, explain every step, and get the job done
            right the first time. No surprise fees. No upselling. Just honest plumbing work
            from a team that stands behind it.
          </p>
