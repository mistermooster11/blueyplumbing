      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Plumbing in Menlo Park &amp; the Bay Area
          </h2>
          <p className="faq__subtext">
            Find clear answers about our residential and commercial plumbing services, service area,
            licensing, upfront pricing, and emergency response across the Bay Area Peninsula.
          </p>
