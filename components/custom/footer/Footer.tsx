  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>Bluey Plumbing &amp; Rooter</strong> — Bay Area plumbers serving Menlo Park and the
            Peninsula. Drain services, gas lines, water heaters, and fixtures. Licensed, insured, and
          ...
          <div className="footer__socials">
            ...
            <a href="https://www.yelp.com/biz/bluey-plumbing-and-rooter-menlo-park" target="_blank" rel="noopener noreferrer" aria-label="Yelp" className="footer__social-link">
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 Bluey Plumbing &amp; Rooter. All rights reserved.</p>
      </div>
    </footer>
  );
}
