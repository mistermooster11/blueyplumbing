  ...
  return (
    <section className="pricing" ref={sectionRef}>
      ...
      <div className="pricing__header">
        ...
        <h2 className="pricing__heading">Transparent Plumbing Pricing</h2>
        <p className="pricing__subtext">
          Clear, upfront pricing for drain services, gas line work, water heater installation,
          and fixture repairs — residential and commercial — with no hidden fees across the
          Bay Area Peninsula.
        </p>
      </div>
