    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Professional Plumbing Services Across the Bay Area Peninsula
        </h2>
        <p className="services__subtext">
          Reliable residential and commercial plumbing — drain services, gas lines, water heaters,
          and fixture repairs — serving Menlo Park, Palo Alto, Redwood City, and surrounding
